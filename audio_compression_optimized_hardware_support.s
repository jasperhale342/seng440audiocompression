	...
	.eabi_attribute 30, 6
	.eabi_attribute 18, 4
	.file	"audio_compression_optimized_hardware_support.c"
	.global	__aeabi_i2d
	.global	__aeabi_ddiv
	.section	.rodata
	.align	2
...
codeword_decompression:
	...
	ldr	r3, [fp, #-8]
#APP
@ 210 "audio_compression_optimized_hardware_support.c" 1
	alaw   r3, r2, r3
@ 0 "" 2
	str	r3, [fp, #-12]
	ldr	r3, [fp, #-12]
...
codeword_compression:
	...
	mov	r3, #1
#APP
@ 316 "audio_compression_optimized_hardware_support.c" 1
	alaw   r3, r0, r3
@ 0 "" 2
	and	r2, r3, #255
	mov	r3, r2
